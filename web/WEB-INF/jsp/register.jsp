...
<head>
    ...
    <link href="<%=basePath%>/resource/css/normalize.css" rel="stylesheet"/>
    <link href="<%=basePath%>/resource/css/jquery-ui.css" rel="stylesheet"/>
    <link href="<%=basePath%>/resource/css/jquery.idealforms.min.css" rel="stylesheet" media="screen"/>

    <style type="text/css">
        body {
            font: normal 15px/1.5 Arial, Helvetica, Free Sans, sans-serif;
            color: #222;
            background: url(<%=basePath%>/resource/pattern.png);
            overflow-y: scroll;
            padding: 60px 0 0 0;
        }
    ...
    <div class="eightcol last">
        ...
        <form id="my-form">
            ...
            <section name="第一步">
                ...
                <div><label>出生日期:</label><input name="date" class="datepicker" data-ideal="date" type="text"
...
<script type="text/javascript" src="<%=basePath%>/resource/js/jquery.idealforms.js"></script>
